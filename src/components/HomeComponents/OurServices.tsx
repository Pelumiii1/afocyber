...
const OurServices = () => {
  return (
    <>
      <div className="lg:hidden text-center leading-[60px]">
      ...
      <div className="hidden md:grid grid-cols-3 pt-10 gap-5 px-[2rem] lg:px-[4rem] font-[family-name:var(--font-manrope)] text-white py-5 z-40">
        <div className="flex flex-col items-center">
          ...
          <div className="flex flex-col justify-between p-5 bg-[#FFFFFF0D] lg:h-[240px] rounded-[20px] text-center lg:w-[350px]">
            <div>
        ...
        <div className="flex flex-col items-center justify-between">
          ...
          <div className="flex flex-col items-center">
            <div className="hidden lg:flex img">
            ...
            <Image
              ...
              width={15}
            />
            <div className="flex flex-col justify-between w-fit p-5 bg-[#FFFFFF0D] lg:h-[240px] rounded-[20px] text-center">
              <div>
                <div className="border-b pb-2">
